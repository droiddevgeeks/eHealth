...
public class DeviceControlActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mDeviceName = intent.getStringExtra(ApplicationContants.EXTRAS_DEVICE_NAME);
        mDeviceAddress = intent.getStringExtra(ApplicationContants.EXTRAS_DEVICE_ADDRESS);
